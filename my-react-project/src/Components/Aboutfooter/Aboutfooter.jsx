...
export default function Aboutfooter() {
  return (
    <>
    <div className="lastsec1 px-5 pb-5 pt-2 ">

   <div className='topoffooter'>
<div className='d-flex text-start'> 
    <div className='iconimg'><GrLocation /></div>
    <div><h5>Address</h5> 
    <h4>4648 Rocky Road Philadelphia PA</h4>
    </div>
</div>
<div className='d-flex text-start'>
    <div className='iconimg'><SlEnvolopeLetter /></div>
    <div><h5>Address</h5> 
    <h4>4648 Rocky Road Philadelphia PA</h4>
    </div>
    </div>
<div className='d-flex text-start'>
    <div className='iconimg'><BsTelephonePlusFill /></div>
    <div><h5>Address</h5> 
    <h4>4648 Rocky Road Philadelphia PA</h4>
    </div>
   </div>
